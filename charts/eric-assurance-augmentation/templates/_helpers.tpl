...
*/}}
{{- define "eric-assurance-augmentation.name" -}}
...
*/}}
{{- define "eric-assurance-augmentation.labels" -}}
app.kubernetes.io/name: {{ include "eric-assurance-augmentation.name" . }}
...
*/}}
{{- define "eric-assurance-augmentation.kubernetes-io-info" -}}
...
*/}}
{{ define "eric-assurance-augmentation.global" }}
...
*/}}
{{- define "eric-assurance-augmentation.release.name" -}}
...
*/}}
{{- define "eric-assurance-augmentation.service-mesh.enabled" }}
...
*/}}
{{- define "eric-assurance-augmentation.service-mesh-ingress.enabled" -}}
{{ if .Values.global.serviceMesh }}
...
*/}}
{{- define "eric-assurance-augmentation.global-security-tls-enabled" -}}
{{- if  .Values.global -}}
